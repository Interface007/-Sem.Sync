...
namespace Sem.Sync.Cloud
{
    ...
    public interface IStorage
    {
        ...
        /// <returns> All contacts from that folder. </returns>
        [OperationContract]
        ...
        /// <param name="folderId"> The folder id.  </param>
        /// <param name="skipIfExisting"> Skips existing contacts if implemented by the concrete service. </param>
        ...
        /// </summary>
        /// <param name="folderId"> The folder id to delete the content from. </param>
        /// <returns> A value indicating the success of the operation.  </returns>
        [OperationContract]
