...
namespace Sem.Sync.SyncBase
{
    ...
    public class SyncEngine : SyncComponent
    {
            ...
            catch (Exception ex)
            {
                ...
                ExceptionHandler.HandleException(
                    new TechnicalException(
                        ...
                        new KeyValuePair<string, object>("WebResponse", ExtractWebExceptionContent(ex))));
        ...
        private static string ExtractWebExceptionContent(Exception ex)
        {
            ...
            var extractWebExceptionContent = new StreamReader(webException.Response.GetResponseStream()).ReadToEnd();
            return extractWebExceptionContent;
        }
