...
namespace Sem.Sync.Connector.Outlook2010
{
    ...
    /// This class is the client class for handling outlook calendar items
    /// </summary>
    [ConnectorDescription(DisplayName = "Microsoft Outlook 2010", CanReadContacts = false, CanWriteContacts = false, 
                ...
                else
                {
                    ...
                    for (var itemIndex = 1; itemIndex <= calendarItems.Count; itemIndex++)
                    {
                        ...
                        try
                        {
                            ...
                            {
                                // && calendarStdItem.Start > minimumDate)
                                currentElementName =
            ...
            foreach (var element in elements)
            {
                    ...
                    )
                {
                    ...
                    case SaveAction.Create:
                        ...
                        break;
                    default:
                        throw new ArgumentOutOfRangeException("elements", Resources.UserInfoElementCannotBeSaved);
                }
            }
