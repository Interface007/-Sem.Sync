...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.1" xmlns:MSHelp="http://msdn.microsoft.com/mshelp" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
  ...
  <xsl:variable name="hasSeeAlsoSection" select="boolean( 
  ...
  <xsl:variable name="securityCriticalSection" select="boolean(
    ...
    <xsl:if test="/document/reference/attributes/attribute/type[@api='T:System.FlagsAttribute']">
      <p>
        <include item="flagsSummary">
          <parameter>
            <referenceLink target="{/document/reference/attributes/attribute/type/@api}" />
          </parameter>
        </include>
      </p>
    </xsl:if>
  ...
  <xsl:template name="getOverloadSummary"></xsl:template>

  <xsl:template name="getOverloadSections"></xsl:template>
