...
namespace Sem.Sync.Connector.Google
{
    ...
    internal static class GoogleContactMappingExtensions
    {
        ...
        /// </summary>
        /// <param name="googleContact">
        /// The google contact. 
        /// </param>
        /// <param name="stdAddress">
        /// The <see cref="AddressDetail"/> data from the <see cref="StdContact"/>. 
        /// </param>
        /// <param name="addressType">
        /// A text type of address ("home", "work"). 
        /// </param>
        ...
        /// </summary>
        /// <param name="googleContact">
        /// The google contact to add the information to. 
        /// </param>
        /// <param name="email">
        /// The email address. 
        /// </param>
        /// <param name="addressType">
        /// The address type (home or work). 
        /// </param>
        ...
        /// The google contact to add the information to. 
        /// </param>
        /// <param name="instantMessengerAddresses">
        /// The instant messenger addresses. 
        /// </param>
        /// <param name="addressType">
        /// The address type (home or work). 
        /// </param>
        public static void AddIMAddress(
            this Contact googleContact, InstantMessengerAddresses instantMessengerAddresses, string addressType)
        {
        ...
        /// The google contact. 
        /// </param>
        /// <param name="stdBusinessCompanyName">
        /// The business company name to add. 
        /// </param>
        /// <param name="stdBusinessDepartment">
        /// The business department name to add - this parameter is currently ignored. 
        /// </param>
        /// <param name="stdBusinessPosition">
        /// The business position to add. 
        /// </param>
        public static void AddOrganization(
            this Contact googleContact, 
            string stdBusinessCompanyName, 
            string stdBusinessDepartment, 
            string stdBusinessPosition)
        {
        ...
        /// The google contact. 
        /// </param>
        /// <param name="stdPhoneNumber">
        /// The std phone number. 
        /// </param>
        /// <param name="addressType">
        /// The address type. 
        /// </param>
        ...
        /// The organization information from the google contact. 
        /// </param>
        ...
        /// The std entry. 
        /// </param>
        /// <param name="instantMessengerAddress">
        /// The IM address. 
        /// </param>
        ...
        /// The phone number to set into the std entry. 
        /// </param>
        ...
        /// </param>
        /// <param name="contact">
        /// The contact containing the image information. 
        /// </param>
        /// <param name="credentials">
        /// The credentials providing object. 
        /// </param>
        public static void UpdatePhoto(this Contact googleContact, StdContact contact, ContactClient credentials)
        {
            ...
            var rs = new RequestSettings(
                "Sem.Sync.Connector.Google", credentials.LogOnUserId, credentials.LogOnPassword) {
                                                                                                    AutoPaging = true 
                                                                                                 };
        ...
        /// </summary>
        /// <param name="googleAddresses">
        /// The google address collection. 
        /// </param>
        /// <param name="stdAddress">
        /// The <see cref="AddressDetail"/> data from the <see cref="StdContact"/>. 
        /// </param>
        /// <returns>
        /// true if the address is already part of the collection 
        /// </returns>
        ...
        private static void UnlockCaptch()
        {
            ...
            else
            {
                throw new InvalidOperationException(
                    "Google requests a captcha to be resolved in order to reactivate the account, but the UI handler to resolve the captcha has not been setup yet. Make sure the GenericUiResponder property of the static GoogleContactMappingExtensions class has been setup properly.");
            }
        }
