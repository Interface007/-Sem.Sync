  ...
  <xsl:template name="ShowAuthoredXamlSyntax">
    <xsl:if test="ddue:content[normalize-space(.)!='']">
      <xsl:variable name="headingID">
        <xsl:choose>
          <xsl:when test="starts-with(@address,'xamlObjectElementUsage')">
            xamlObjectElementUsageHeading
          </xsl:when>
          <xsl:when test="starts-with(@address,'xamlImplicitCollectionUsage')">
            xamlImplicitCollectionUsageHeading
          </xsl:when>
          <xsl:when test="starts-with(@address,'xamlPropertyElementUsage')">
            <xsl:choose>
              <xsl:when test="//div[@class='xamlContentElementUsageHeading']">
          ...
          <xsl:when test="starts-with(@address,'xamlAttributeUsage')">
            xamlAttributeUsageHeading
          </xsl:when>
          <xsl:when test="starts-with(@address,'xamlTextUsage')">
