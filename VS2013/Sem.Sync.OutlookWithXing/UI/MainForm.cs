...
namespace Sem.Sync.OutlookWithXing.UI
{
    ...
    using Sem.Sync.OutlookWithXing.Properties;
    ...
    public partial class MainForm : Form
    {
        ...
        private readonly SyncEngine engine = new SyncEngine
            {
                WorkingFolder =
                    Path.Combine(
                        Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "SemSyncXing2Outlook"), 
        ...
        public MainForm()
        {
            ...
            this.DoubleClick +=
                (sender, e) => System.Diagnostics.Process.Start(ExceptionHandler.ExceptionWriter[0].Destination);
