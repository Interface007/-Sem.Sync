...
namespace Sem.Sync.CloudStorageConnector.CloudStorage {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://svenerikmatzen.com/Sem/Sync/OnlineStorage", ConfigurationName="CloudStorage.IStorage")]
    public interface IStorage {
        ...
        Sem.Sync.CloudStorageConnector.CloudStorage.ContactListContainer GetAll(string blobId);
        ...
        bool WriteFullList(Sem.Sync.CloudStorageConnector.CloudStorage.ContactListContainer elements, string blobId, bool skipIfExisting);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public interface IStorageChannel : Sem.Sync.CloudStorageConnector.CloudStorage.IStorage, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public partial class StorageClient : System.ServiceModel.ClientBase<Sem.Sync.CloudStorageConnector.CloudStorage.IStorage>, Sem.Sync.CloudStorageConnector.CloudStorage.IStorage {
        ...
        public Sem.Sync.CloudStorageConnector.CloudStorage.ContactListContainer GetAll(string blobId) {
            return base.Channel.GetAll(blobId);
        }
        
        public bool WriteFullList(Sem.Sync.CloudStorageConnector.CloudStorage.ContactListContainer elements, string blobId, bool skipIfExisting) {
