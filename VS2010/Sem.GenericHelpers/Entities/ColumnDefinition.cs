...
namespace Sem.GenericHelpers.Entities
{
    ...
    public class ColumnDefinition
    {
        ...
        public XElement TransformationFromDatabaseSyntax
        {
            get
            {
                return this.TransformationFromDatabase == null
                           ? null
            ...
            set
            {
                if (value != null)
                {
                    this.TransformationFromDatabase =
                        this.serializer.Deserialize<Func<ColumnDefinition, object, object>>(value);
                }
            }
        }
        ...
        public XElement TransformationToDatabaseSyntax
        {
            get
            {
                return this.TransformationToDatabase == null
                           ? null
            ...
            set
            {
                if (value != null)
                {
                    this.TransformationToDatabase =
                        this.serializer.Deserialize<Func<ColumnDefinition, object, string>>(value);
                }
            }
        }
