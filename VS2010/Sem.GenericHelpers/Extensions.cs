...
namespace Sem.GenericHelpers
{
    ...
    public static class Extensions
    {
        ...
        /// </param>
        /// <returns>
        /// The default string if the checked string is null or empty, the checked string otherwise 
        /// </returns>
        ...
        /// The IEnumerable to get the elements from. 
        /// </param>
        /// <param name="action">
        /// The action to be performed (eg. a lambda). 
        /// </param>
        /// <typeparam name="T">
        /// the type parameter of the IEnumerable member 
        /// </typeparam>
        ...
        /// The parameter to call the action. 
        /// </param>
        /// <typeparam name="T1">
        /// the type parameter of the IEnumerable member  
        /// </typeparam>
        /// <typeparam name="T2">
        /// the type parameter of the parameter <paramref name="parameter1"/> member  
        /// </typeparam>
        ...
        /// </param>
        /// <typeparam name="T">
        /// The type to test and return 
        /// </typeparam>
        /// <returns>
        /// the non-null value or a new object if the original value was null 
        /// </returns>
        ...
        /// </typeparam>
        /// <returns>
        /// the existing element or a new element, if the element does not exist  
        /// </returns>
        ...
        /// </param>
        /// <typeparam name="T">
        /// The type of elements inside the collection 
        /// </typeparam>
        /// <returns>
        /// the existing element or a new element, if the element does not exist  
        /// </returns>
        ...
        /// </param>
        /// <typeparam name="T">
        /// The type of elements inside the Dictionary 
        /// </typeparam>
        /// <returns>
        /// the existing element or a new element, if the element does not exist  
        /// </returns>
