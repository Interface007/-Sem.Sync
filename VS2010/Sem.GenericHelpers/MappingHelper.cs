...
namespace Sem.GenericHelpers
{
    ...
    public static class MappingHelper
    {
        ...
        /// </summary>
        /// <param name="dirty">
        /// The dirty-flag (set to true if a modification in the destination object has been done). 
        /// </param>
        /// <param name="newStd">
        /// The new std element. 
        /// </param>
        ...
        /// The old std element. 
        /// </param>
        /// <param name="valueExtractionExpression">
        /// The expression to extract the value from the source type. 
        /// </param>
        /// <param name="setter">
        /// The setter method for the destination object. 
        /// </param>
        ...
        /// The root object. 
        /// </param>
        /// <param name="evaluationFunction1">
        /// The function for the 1st evaluation. 
        /// </param>
        /// <param name="evaluationFunction2">
        /// The function for the 2nd evaluation. 
        /// </param>
        /// <param name="evaluationFunction3">
        /// The function for the 3rd evaluation 
        /// </param>
        /// <param name="target">
        /// The target of the mapping. 
        /// </param>
        /// <typeparam name="TResult1">
        /// The result type of the 1st evaluation. 
        /// </typeparam>
        /// <typeparam name="TResult2">
        /// The result type of the 2nd evaluation. 
        /// </typeparam>
        /// <typeparam name="TResult3">
        /// The result type of the 3rd evaluation. 
        /// </typeparam>
        ...
        /// </param>
        /// <param name="evaluationFunction1">
        /// The expression that does describe the path to the property. 
        /// </param>
        /// <param name="target">
        /// The target property to write the result of the expression. 
        /// </param>
        /// <typeparam name="TResult1">
        ...
        /// </summary>
        /// <param name="expressionToGetTheFunctionFor">
        /// The expression that should be translated into a compiled function 
        /// </param>
        /// <typeparam name="TObject">
        /// The type of the object that is the parameter for the function 
        /// </typeparam>
        /// <typeparam name="TResult1">
        /// The type of the result of the function 
        /// </typeparam>
        /// <returns>
        /// The compiled function that is equivalent to the expression 
        /// </returns>
