    ...
    public class MatchByProfileId : SyncComponent, ISyncCommand
    {
            ...
            string commandParameter)
        {
            ...
            targetClient.WriteRange(
                MatchThisByProfileId(sourceClient.GetAll(sourceStorePath), baseline), targetStorePath);
            return true;
        }
        ...
        /// </summary>
        /// <param name="target">
        /// the list of <see cref="StdContact"/> that contains the target (here the <see cref="StdElement.Id"/> will be changed if a match is found in the baseline) 
        /// </param>
        /// <param name="baseline">
        /// the list of <see cref="StdElement"/> that contains the source of the baseline (this will not be changed, but need to contain entries of type <see cref="MatchingEntry"/>) 
        /// </param>
        /// <returns>
