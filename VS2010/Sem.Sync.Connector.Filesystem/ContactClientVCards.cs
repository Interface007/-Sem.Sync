...
namespace Sem.Sync.Connector.Filesystem
{
    ...
    /// This class is the client class for handling contacts
    /// </summary>
    [ClientStoragePathDescription(Mandatory = true, Default = "{FS:WorkingFolder}\\vCards", 
    ...
    public class ContactClientVCards : StdClient
    {
        ...
        ///   config file for configuration entries for this class.
        /// </summary>
        /// <param name="savePictureExternal">
        /// determines if the picture should be saved externally, too 
        /// </param>
        ...
        /// The client folder name for the destination/source of the vCards. 
        /// </param>
        ...
        /// </summary>
        /// <param name="clientFolderName">
        /// the name of the folder that does contain the vCard files.
        /// </param>
        /// <param name="result">
        /// A list of StdElements that will get the new imported entries.
        /// </param>
        /// <returns>
        /// The list with the added vCard-contacts
        /// </returns>
