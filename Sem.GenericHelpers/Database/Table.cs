namespace Sem.GenericHelpers.Database
{
    ...
    public class Table
    {
        ...
        public string ToScript()
        {
            ...
            thisTable.Append("-- -- -- ");
            thisTable.AppendLine(this.Name);
            ...
            thisTable.AppendLine("-- -- -- Primary Key Column");
            ...
            thisTable.AppendLine("-- -- -- Data Columns");
            ...
            subTables.AppendLine("-- -- -- Primary Key Constraint");
        ...
        public string ToScriptReferences()
        {
            ...
            subTables.Append("-- -- -- ");
            subTables.AppendLine(this.Name);
